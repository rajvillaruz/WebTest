...
public class PdfUtility {
	...
	public void WriteTestResultToPdfFile(String fileName, List<String> testCase)
		...
		try {
			String file = "C:\\Users\\rochelle\\Documents\\Workspace\\SeleniumTraining\\WebTest.pdf";
			...
			// get fontHeight
			final float fontHeight = ((PDSimpleFont) font).getFontDescriptor().getFontBoundingBox().getHeight() / 1000
					* fontSize;
